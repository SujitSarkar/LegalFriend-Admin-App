...
class MadokDondobidhiPage extends StatefulWidget {
  ...
  @override
  _MadokDondobidhiPageState createState() => _MadokDondobidhiPageState();
}

class _MadokDondobidhiPageState extends State<MadokDondobidhiPage>
  ...
  Widget _allDataWidget(double size, PublicProvider publicProvider,
          DatabaseProvider databaseProvider) => Column(
        children: [
          ///Search Header
          Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${Variables.mamlarDhoron} - ${Variables.madokDondobidhi}',
    ...
    if (_formKey.currentState!.validate()) {
      if (_amoliAdalot != null && _jojCourt != null && _mamlaNo != null) {
        ...
        Map<String, String> map = {
          ...
          'joj_court': _jojCourt!,
          'mamlar_dhoron': Variables.madokDondobidhi,
                              ...
                              onPressed: (){
                                if(_formKey.currentState!.validate()){
                                  ...
                                  if(pdfDataList.isNotEmpty) {
                                    SavePDF.savePdf(pdfDataList,Variables.madokDondobidhi,context);
                                  } else {
